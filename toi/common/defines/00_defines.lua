...
NDiplomacy = {
	...
	TENSION_NO_CB_WAR = 20,							-- Amount of tension generated by a no-CB wargoal
	...
	TENSION_GENERATE_WARGOAL = 1.3,					-- Amount of tension generated by generating a wargoal against a country
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.25,			-- Amount of tension generated for each sent division
	TENSION_DECAY = 0.0125,							-- Each months tension decays this much
